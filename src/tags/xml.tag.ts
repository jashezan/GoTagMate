...
export const fetchXMLKeywords: ITag = {
    ...
    tag_list: [
        {
            tag_name: ",attr",
            tag_description: "Maps the field to an XML attribute value instead of an element",
            tag_usage: [
                'xml:"id,attr"',
        ...
        {
            tag_name: ",omitempty",
            tag_description: "Omits the field from XML output if it contains an empty value (zero value)",
            tag_usage: [
        ...
        {
            tag_name: ">",
            tag_description: "Descends into nested XML elements using > as a path separator",
            tag_usage: [
                'xml:"name>first"',
        ...
        {
            tag_name: ",chardata",
            tag_description: "Maps XML character data (text content) directly to the field",
            tag_usage: [
                'xml:",chardata"',
        ...
        {
            tag_name: ",innerxml",
            tag_description: "Captures raw XML content including tags as a string or []byte",
            tag_usage: [
                'xml:",innerxml"',
        ...
        {
            tag_name: "-",
            tag_description: "Prevents the field from being marshaled/unmarshaled in XML",
            tag_usage: [
                'xml:"-"',
        ...
        {
            tag_name: ",any",
            tag_description: "Maps any unmatched XML elements or attributes to this field",
            tag_usage: [
                'xml:",any"',
